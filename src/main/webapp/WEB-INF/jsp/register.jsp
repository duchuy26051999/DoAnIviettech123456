...
<%--                    </div>--%>
    ...
    <section class="main-content">
        <div class="row">
            <h4 class="title" align="center" style="width: 99%;margin-left: 20px;font-size: 20px"><span class="text"><strong>Đăng ký người dùng</strong></span></h4>
            <div class="span7" style="width: 99%;margin-left: 21px;background-image: url(${pageContext.request.contextPath}/themes/images/carousel/slider_9.jpg)">
                <div style="width: 400px;margin-left: 380px;background: #00bcd4;text-align: center;min-height: 430px;margin-bottom: 10px;border-radius: 50px">
                    ...
                    <mvc:form modelAttribute="customer" action="/registerKH" method="post">
                    <fieldset style="margin-top: 10px">
                        <div class="control-group">
                            <label class="control-label" style="margin-top: 10px;font-size: 15px">Họ tên</label>
                            <div class="controls">
                                <mvc:input path="customerName" required="true"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" style="font-size: 15px">Địa chỉ</label>
                            <div class="controls">
                                <mvc:input path="address" required="true"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" style="font-size: 15px">Số điện thoại</label>
                            <div class="controls">
                                <mvc:input path="phoneNumber" required="true"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Số CMND</label>
                            <div class="controls">
                                <mvc:input path="idNumber" required="true"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Email</label>
                            <div class="controls">
                                <mvc:input type="email" path="email" required="true"/>
                            </div>
                        </div>
