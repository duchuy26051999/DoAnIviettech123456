...
<%--                    </div>--%>
    ...
    <section class="main-content">
        <div class="row">
            <h4 class="title" align="center" style="width: 99%;margin-left: 20px;font-size: 20px"><span class="text"><strong>Create Goods</strong> Form</span></h4>
            <div class="span7" style="width: 99%;margin-left: 21px;background-image: url(${pageContext.request.contextPath}/themes/images/carousel/slider_9.jpg)">
                <div style="width: 400px;margin-left: 380px;background: #00bcd4;text-align: center;height: 450px;margin-bottom: 10px;border-radius: 50px">
                    <mvc:form modelAttribute="goodsUpdate" action="${pageContext.request.contextPath}/user/saveGood">
                        <fieldset style="margin-top: 10px">
                            <div class="control-group">
                                <label class="control-label" style="margin-top: 10px">ID:</label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <mvc:textarea cssStyle="width: 300px;height: 100px" path="goodDescription" required="true"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Category: </label>
                                <div class="controls">
                                    <mvc:select path="category.id">
