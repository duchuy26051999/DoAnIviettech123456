            ...
            <div class="span9">
                <div class="row">
                    <div class="span9" style="width: 1170px;">
                        <h4 class="title" align="center" style="font-size: 17px;margin-top: -50px"><span class="text"><strong>Lịch sử đấu giá</strong></span></h4>
                        <p style="color: red" align="center">${message}</p>
                        <div>
                            <form action="${pageContext.request.contextPath}/user/myBid/searchBid/1" method="post" style="margin-left: 5px">
                            ...
                            <strong style="margin-left: 10px;margin-top: 25px;float: left">
                                <a href="/user/myBid"><input type="submit" value="Xem tất cả" style="height: 30px;font-size: 14px; background: #fbb450"></a>
                            </strong>
                        </div>
                        ...
                        <div class="tab-pane" id="home">
                            <div class="tab-pane active" id="bid">
                                <table>
                                    ...
                                    <tbody>
                                    <c:forEach var="bid" items="${bid.pageList}">
                                        <tr>
                                            <td>${bid.auction.id}</td>
                                            <td>${bid.auction.goods.goodName}</td>
        ...
        <div id="ppppppp">
            <ul class="pagination">
                <li class="${currentIndex == 1}? 'page-item disabled' : 'page-item'">
                    <a class="page-link" href="${pageContext.request.contextPath}/user/myBid/page/1"><input type="button" value="First"></a>
                </li>
                <li class="${currentIndex == 1}? 'page-item disabled': 'page-item' ">
