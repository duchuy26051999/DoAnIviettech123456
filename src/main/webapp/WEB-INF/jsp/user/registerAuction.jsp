...
<%--                    </div>--%>
    ...
    <section class="main-content">
        <div class="row">
            <h4 class="title" align="center" style="width: 99%;margin-left: 20px;font-size: 20px"><span class="text"><strong>Tạo phiên đấu giá</strong></span></h4>
            <div class="span7" style="width: 99%;margin-left: 21px;background-image: url(${pageContext.request.contextPath}/themes/images/carousel/slider_9.jpg)">
                <div style="width: 400px;margin-left: 380px;background: #00bcd4;text-align: center;min-height: 430px;margin-bottom: 10px;border-radius: 50px">
                    <p style="color: red">${mess1}</p>
                <mvc:form modelAttribute="auction" action="${pageContext.request.contextPath}/user/newAuction" method="post">
                    <fieldset style="margin-top: 10px;">
                        <div class="control-group">
                            <label class="control-label" style="margin-top: 10px;font-size: 15px">Ngày bắt đầu </label>
                            <div class="controls">
                                <mvc:input type="datetime-local" path="dateStart" required="true" placeholder="day/month/year hours:minute PM/AM"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" style="font-size: 15px">Ngày kết thúc </label>
                            <div class="controls">
                                <mvc:input type="datetime-local" path="dateEnd" required="true" placeholder="day/month/year hours:minute PM/AM"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" style="font-size: 15px">Giá khởi điểm </label>
                            <div class="controls">
                                <mvc:input path="priceStart" required="true"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" style="font-size: 15px">Giá mong muốn </label>
                            <div class="controls">
                                <mvc:input path="desiredPrice" required="true"/>
                            </div>
                        </div>

                        <div class="control-group">
                            <label class="control-label" style="font-size: 15px">Sản phẩm </label>
                            <div class="controls">
                                <mvc:select path="goods.id">
                                    <mvc:option value="0" label="--danh sách sản phẩm--"/>
                                    <mvc:options items="${listGoods}"/>
                                </mvc:select>
                            </div>
                        </div>
                        <div class="actions"><input tabindex="9" class="btn btn-primary large" id="submit1" type="submit" value="Tạo phiên đấu giá" style="background: #df8505"></div>
