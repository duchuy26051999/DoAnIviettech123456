...
<%--                    </div>--%>
    ...
    <section class="main-content">
        <div class="row">
                <h4 class="title" align="center" style="width: 99%;margin-left: 20px;font-size: 20px"><span class="text"><strong>Tạo sản phẩm </strong> đấu giá</span></h4>
                <div class="span7" style="width: 99%;margin-left: 21px;background-image: url(${pageContext.request.contextPath}/themes/images/carousel/slider_9.jpg)">
                    <div style="width: 400px;margin-left: 380px;background: #00bcd4;text-align: center;height: 430px;margin-bottom: 10px;border-radius: 50px">
                        <mvc:form modelAttribute="good" action="${pageContext.request.contextPath}/user/newGood" enctype="multipart/form-data" method="post">
                            <fieldset style="margin-top: 10px">
                                <div class="control-group">
                                    <label class="control-label" style="margin-top: 10px;font-size: 15px">Tên sản phẩm</label>
                                    <div class="controls">
                                        <mvc:input cssStyle="width: 300px" path="goodName" required="true"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" style="font-size: 15px">Mô tả </label>
                                    <div class="controls">
                                        <mvc:textarea cssStyle="height: 100px;width: 300px" path="goodDescription" required="true"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" style="font-size: 15px">Thể loại </label>
                                    <div class="controls">
                                        <mvc:select path="category.id" cssStyle="width: 315px">
                                            <mvc:option value="0" label="--Select Category--"/>
                                            <mvc:options items="${categoryList}"/>
                                        </mvc:select>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" style="font-size: 15px;">Danh sách hình ảnh</label>
                                    <div class="controls">
                                        <input type="file" name="photo" multiple required style="width: 315px"/>
                                    </div>
                                </div>
                                <div class="actions"><input tabindex="9" class="btn btn-primary large" id="submit1" type="submit" value="Tạo sản phầm" style="background: #df8505"></div>
