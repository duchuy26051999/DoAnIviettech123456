...
<%--                    </div>--%>
    ...
    <section class="main-content">
        <div class="row">
            <h4 class="title" align="center" style="font-size: 19px"><span class="text"><strong>Check Out Orders</strong></span></h4>
            <div class="span7" style="width: 99%;margin-left: 21px;background-image: url(${pageContext.request.contextPath}/themes/images/carousel/slider_9.jpg)">
                ...
                <mvc:form modelAttribute="orders" action="${pageContext.request.contextPath}/user/checkout">
                    <fieldset style="margin-top: 10px">
                        <div class="control-group">
                            <label class="control-label" style="margin-top: 10px;font-size: 14px">Mã đơn hàng</label>
                            <div class="controls">
                                <mvc:input path="id" readonly="true"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" style="font-size: 14px">Tên khách hàng </label>
                            <div class="controls">
                                <mvc:input path="customerName" required="true"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" style="font-size: 14px">Địa chỉ </label>
                            <div class="controls">
                                <mvc:input path="customerAddress" required="true"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" style="font-size: 14px">Số điện thoại </label>
                            <div class="controls">
                                <mvc:input path="phone_Number" required="true"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" style="font-size: 14px">Tên sản phẩm </label>
                            <div class="controls">
                                <mvc:input path="goods_Name" readonly="true"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" style="font-size: 14px">Ngày thắng thầu </label>
                            <div class="controls">
                                <mvc:input path="dateWin" readonly="true"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <mvc:input path="auction" type="hidden"/>
                            </div>
                        </div>
                        <div class="actions"><input tabindex="9" class="btn btn-primary large" id="submit1" type="submit" value="Xác nhận" style="background: #df8505;"></div>
                    </fieldset>
