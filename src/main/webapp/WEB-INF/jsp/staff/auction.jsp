                            ...
                            <div class="calendar-heading">
                                ...
                                <div class="agile-tables">
                                    <div class="w3l-table-info">
                                        ...
                                        <form action="${pageContext.request.contextPath}/staff/searchAuctionName" method="post">
                                            <input type="text" name="search" required placeholder="Nhập (tên khách hàng, hàng hóa)">
                                            <select name="status">
                                                <option>start</option>
                                                <option>close</option>
                                                <option>new</option>
                                            ...
                                            <a href="${pageContext.request.contextPath}/staff/manageAuction"><input type="button" value="Xem tất cả"></a>
                                        </form>
                                        <table id="table">
                                            <thead >
                                            <tr >
...
<%--							<span >--%>
<%--								<a class="agile-icon" href="${pageContext.request.contextPath}/staff/updateAuction/${auction.id}"><i class="fa fa-pencil-square-o"></i></a>--%>
<%--							</span>--%>
<%--                                                        <span>--%>
<%--								<a class="agile-icon" href="${pageContext.request.contextPath}/staff/deleteAuction/${auction.id}"><i class="fa fa-times-circle"></i></a>--%>
<%--							</span>--%>
