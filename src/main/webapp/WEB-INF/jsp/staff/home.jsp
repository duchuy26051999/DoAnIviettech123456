...
<div id="wrapper" class="container">
    ...
    <section  class="homepage-slider" id="home-slider">
        <div class="flexslider">
            <ul class="slides">
                <li>
                    <img src="${pageContext.request.contentType}/themes/images/carousel/slider_3.jpg" alt="anh bia 1" style="width: 100%;height: 300px"/>
<%--                    <div class="intro">--%>
...
<%--                    </div>--%>
                ...
                <li>
                    <img src="${pageContext.request.contentType}/themes/images/carousel/slider_8.jpg" alt="anh bia 2" style="width: 100%;height: 300px"/>
                </li>
                <li>
                    <img src="${pageContext.request.contentType}/themes/images/carousel/slider_7.jpg" alt="anh bia 3" style="width: 100%;height: 300px"/>
                </li>
                <li>
                    <img src="${pageContext.request.contentType}/themes/images/carousel/slider_6.jpg" alt="anh bia 4" style="width: 100%;height: 300px" />
                </li>
                <li>
                    <img src="${pageContext.request.contentType}/themes/images/carousel/slider_9.jpg" alt="anh bia 5" style="width: 100%;height: 300px" />
                </li>
            </ul>
        </div>
    </section>
    <section class="header_text">
        Chào nhân viên ${name}!
        <br/>Chúc bạn một ngày làm việc hiệu quả, may mắn và vui vẻ!!!
        <br/>Nào, hãy bắt đầu công việc đi nào LET'S GO!
