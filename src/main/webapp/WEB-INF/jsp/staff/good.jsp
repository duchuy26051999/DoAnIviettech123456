                            ...
                            <div class="calendar-heading">
                                ...
                                <div class="agile-tables">
                                    <div class="w3l-table-info">
                                        ...
                                        <form action="${pageContext.request.contextPath}/staff/searchGoodName" method="post">
                                            ...
                                            <a href="${pageContext.request.contextPath}/staff/manageGood"><input type="button" value="Xem tất cả"></a>
                                        </form>
                                        <table id="table">
                                            <thead >
                                            <tr >
...
<%--                                                <th>Chỉnh sửa</th>--%>
                                            ...
                                            <tr class="info">
                                                ...
                                                <td>${good.status}</td>
                                                <td>${good.customer.customerName}</td>

<%--                                                <td style="text-align: center;">--%>
<%--							<span >--%>
<%--								<a class="agile-icon" href="${pageContext.request.contextPath}/staff/updateGood/${good.id}"><i class="fa fa-pencil-square-o"></i></a>--%>
<%--							</span>--%>
<%--                                                    <span>--%>
<%--								<a class="agile-icon" href="${pageContext.request.contextPath}/staff/deleteGood/${good.id}"><i class="fa fa-times-circle"></i></a>--%>
<%--							</span>--%>
