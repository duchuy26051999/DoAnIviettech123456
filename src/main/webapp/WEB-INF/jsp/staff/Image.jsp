                                    ...
                                    <div class="w3l-table-info">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                                <script>
                                                    const inpFile = document.getElementById("urls");
                                        ...
                                        <form action="${pageContext.request.contextPath}/staff/searchImageName" method="post">
                                            <input type="text" name="search" required placeholder="Nhập tên hàng hóa">
                                            <input type="submit" value="Tìm kiếm">
                                            <a href="${pageContext.request.contextPath}/staff/manageImage"><input type="button" value="Xem tất cả"></a>
                                        </form>
                                        <table id="table">
                                            <thead >
                                            <tr >
                                            ...
                                            <c:forEach var="image" items="${imageList}">
                                                <tr class="info">
                                                    <td>${image.id}</td>
                                                    <td><img src="${pageContext.request.contextPath}/getImage/${image.url}" width="50px" height="50px"></td>
                                                    <td>${image.goods.goodName}</td>

<%--                                                    <td style="text-align: center;">--%>
<%--							<span >--%>
<%--								<a class="agile-icon" href="${pageContext.request.contextPath}/staff/updateImage/${image.id}"><i class="fa fa-pencil-square-o"></i></a>--%>
<%--							</span>--%>
<%--                                                        <span>--%>
<%--								<a class="agile-icon" href="${pageContext.request.contextPath}/staff/deleteImage/${image.id}"><i class="fa fa-times-circle"></i></a>--%>
<%--							</span>--%>
