    ...
    <section class="main-content">
        <div>
            ...
            <div class="form">
                ...
                <form action="${pageContext.request.contextPath}/staff/myDeposit/search/1" method="post" style="margin-left: 380px;float: left">
                ...
                <button style="margin-left: 5px;height: 31px;width: 80px; color: #0e0e0e; background: #fbb450; ">
                    ...
                    <a href="/staff/myDeposit">Xem tất cả</a></button>
<%--                <hr width="100%"/>--%>
            ...
            <div style="margin-bottom: 70px;">
                <ul class="pagination">
                    <li class="${currentIndex == 1}? 'page-item disabled' : 'page-item'">
                        <a class="page-link" href="${pageContext.request.contextPath}/staff/myDeposit/page/1"><input type="button" value="First"></a>
                    </li>
                    <li class="${currentIndex == 1}? 'page-item disabled': 'page-item' ">
