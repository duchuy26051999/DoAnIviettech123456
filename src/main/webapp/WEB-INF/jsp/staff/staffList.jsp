                ...
                <div class="agile-calendar-grid">
                    <div class="page">
                        ...
                        <div class="w3l-calendar-left">
                            <div class="calendar-heading">
                                ...
                                <div class="agile-tables">
                                    <div class="w3l-table-info">
                                        ...
                                        <h2><a href="${pageContext.request.contextPath}/staff/addStaffAccount">Thêm nhân viên</a></h2>
                                        <form action="${pageContext.request.contextPath}/staff/searchStaffName" method="post">
                                            <input type="text" name="search" required placeholder="Nhập (tên khách hàng,địa chỉ)">
                                            <select name="position">
                                                <option>Quản lý</option>
                                                <option>Nhân viên</option>
                                            </select>
                                            <input type="submit" value="Tìm kiếm">
                                            <a href="${pageContext.request.contextPath}/staff/manageStaff"><input type="button" value="Xem tất cả"></a>
                                        </form>
                                        <table id="table">
                                            <thead >
                                            <tr >
							...
							<span >
								<a class="agile-icon" href="${pageContext.request.contextPath}/staff/updateStaff/${staff.id}"><i class="fa fa-pencil-square-o"></i></a>
							</span>
                                                            <%--                                                        <span>--%>
                                                            <%--								<a class="agile-icon" href="${pageContext.request.contextPath}/admin/deleteCustomer/${customer.id}"><i class="fa fa-times-circle"></i></a>--%>
                                                            <%--							</span>--%>
