                                    ...
                                    <div class="w3l-table-info">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                                <form action="${pageContext.request.contextPath}/staff/deposit" method="post">
                                                    <div class="form-group">
                                                        <label for="ma">Tên khách hàng</label>
                                                        <input type="text" value="${creditID.customer.customerName}" class="form-control" required="true" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="ten">Số tài khoản</label>
                                                        <input type="text" name="cardNumber" value="${creditID.cardNumber}" class="form-control" required="true" readonly/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="ten">Số tiền nạp</label>
                                                        <input type="text" name="amount" class="form-control" required="true" placeholder="Nhập số tiền"/>
                                                    </div>
