                            ...
                            <div class="calendar-heading">
                                ...
                                <div class="agile-tables">
                                    <div class="w3l-table-info">
                                        ...
                                        <form action="${pageContext.request.contextPath}/staff/sumDeposit" method="post">
                                            <p>Từ ngày &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Đến ngày</p>
                                            <input type="date" name="day" required>
                                            <input type="date" name="day1" required>
                                            <input type="submit" value="Thống kê">
<%--                                            <a href="${pageContext.request.contextPath}/staff/depositCustomer"><input type="button" value="Xem tất cả"></a>--%>
                                        </form>
                                        ...
                                        <table id="table">
                                            ...
                                            <c:forEach var="deposit" items="${deposit}">
                                                <tr class="info">
                                                    <td>${deposit.id}</td>
                                                    <td>${deposit.credit.cardNumber}</td>
                                                    <td>${deposit.staff.staffName}</td>
                                                    <td><fmt:formatNumber type="number" groupingUsed="true" value="${deposit.amount}" /> VNĐ</td>
