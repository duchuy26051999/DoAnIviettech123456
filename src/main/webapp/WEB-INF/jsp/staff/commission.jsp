                            ...
                            <div class="calendar-heading">
                                ...
                                <div class="agile-tables">
                                    <div class="w3l-table-info">
                                        ...
                                        <form action="${pageContext.request.contextPath}/staff/sumCommission" method="post">
                                            <p>Từ ngày &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Đến ngày</p>
                                            <input type="date" name="day" required>
                                            <input type="date" name="day1" required>
                                            <input type="submit" value="Thống kê">
<%--                                            <a href="${pageContext.request.contextPath}/staff/commission"><input type="button" value="Xem tất cả"></a>--%>
                                        </form>
                                        ...
                                        <table id="table">
                                            ...
                                            <c:forEach var="commission" items="${commission}">
                                                <tr class="info">
                                                    <td>${commission.id}</td>
                                                    <td><fmt:formatNumber type="number" groupingUsed="true" value="${commission.amount}" /> VNĐ</td>
                                                    <td>${commission.auction.id}</td>
                                                    <td>${commission.datePlus}</td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
                                        </table>
