                                    ...
                                    <div class="w3l-table-info">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                                <mvc:form modelAttribute="getStaffID" action="${pageContext.request.contextPath}/staff/saveStaffID" method="post">
                                                    <div class="form-group">
                                                        <label for="ma">ID</label>
                                                        <mvc:input path="id" class="form-control" required="true" readonly="true"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="ma">Tên nhân viên</label>
                                                        <mvc:input path="staffName" class="form-control" required="true" placeholder="Nhập tên nhân viên"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="ten">Địa chỉ</label>
                                                        <mvc:input path="address" class="form-control" required="true" placeholder="Nhập địa chỉ"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="comment">Chức vụ</label>
                                                        <mvc:select path="staffPosition" class="form-control">
                                                            <mvc:options items="${position}" class="form-control"/>
                                                        </mvc:select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="loai">Số điện thoại</label>
                                                        <mvc:input path="phoneNumber" class="form-control" required="true" placeholder="Nhập số điện thoại"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="nsx">Email</label>
                                                        <mvc:input type="email" path="email" class="form-control" required="true" placeholder="Nhập email"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <mvc:input type="hidden" path="account.id" class="form-control" required="true" placeholder="Nhập email"/>
                                                    </div>
