...
<%--                                        </div>--%>
                                        <label>ID :</label><br>
                                        <input type="text" value="${customerID.id}" readonly><br>
                                        <label>Tên khách hàng :</label><br>
                                        <input type="text" value="${customerID.customerName}" readonly><br>
                                        <label>Địa chỉ :</label><br>
                                        <input type="text" value="${customerID.address}" readonly><br>
                                        <label>Số điện thoại :</label><br>
                                        <input type="text" value="${customerID.phoneNumber}" readonly><br>
                                        <label>ID khách hàng :</label><br>
                                        <input type="text" value="${customerID.idNumber}" readonly><br>
                                        <label>Email :</label><br>
                                        <input type="text" value="${customerID.email}" readonly><br>
                                        <label>ID Tài khoản  :</label><br>
                                        <input type="text" value="${customerID.account.id}" readonly><br>
                                    </div>
