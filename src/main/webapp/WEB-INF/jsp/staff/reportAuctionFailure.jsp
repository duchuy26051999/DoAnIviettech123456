                            ...
                            <div class="calendar-heading">
                                ...
                                <div class="agile-tables">
                                    <div class="w3l-table-info">
                                        ...
                                        <form action="${pageContext.request.contextPath}/staff/searchReportAuctionFailure" method="post">
                                            <p>Từ ngày &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Đến ngày</p>
                                                <input type="date" name="day" required>
                                                <input type="date" name="day1" required>
                                            <input type="submit" value="Tìm kiếm">
                                            <a href="${pageContext.request.contextPath}/staff/reportAuctionFailure"><input type="button" value="Xem tất cả"></a>
                                        </form>
                                        <table id="table">
                                            <thead >
                                            <tr >
