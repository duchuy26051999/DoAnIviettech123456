                                    ...
                                    <div class="w3l-table-info">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                                <form action="${pageContext.request.contextPath}/staff/saveAccount" method="post">
                                                    <div class="form-group">
                                                        <input type="hidden" class="form-control" name="id" value="${accountStaff.id}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Username</label>
                                                        <input type="text" class="form-control" name="username" value="${accountStaff.userName}" readonly>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Password</label>
                                                        <input type="password" name="password" value="${accountStaff.passWord}" class="form-control">
                                                    </div>
                                                    <div class="form-group">
