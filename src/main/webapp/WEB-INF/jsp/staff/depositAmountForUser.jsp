...
<head>
    <meta charset="utf-8">
    <title>Deposit amount for user</title>
...
<div id="wrapper" class="container">
    ...
    <section class="main-content">
        <div>
            <p>${message}</p>
            <h4 class="title" align="center"><span class="text"><strong>Nạp tiền cho tài khoản</strong></span></h4><br>
            <div class="form" style="min-height: 80px">
<%--                <h4 align="center" style="margin-top:-10px">Nạp tiền cho tài khoản</h4>--%>
                <p style="color:red;" align="center">${message1}</p>
                <form action="/staff/deposit" method="post" style="margin-left: 160px">
                    <input type="text" value="${credit.customer.customerName}" readonly style="margin-top: 22px">
                    <input type="text" value="${credit.cardNumber}" name="cardNumber" readonly style="margin-top: 22px"/>
                    <input type="text" name="amount" placeholder="Nhập số tiền" style="margin-top: 22px" required>VND</input>
                    <input id="deposit" type="submit" name="deposit" value="Nạp tiền" style="margin-top: 12px">
                    <button style="margin-left: 5px;height: 31px;width: 85px;font-size: 14px;margin-top: 12px ;color: #0e0e0e; background: #fbb450; ">
...
<%--                        <td><a><input type="button" value="Nạp tiền" style="font-size: 15px;width: 100px;height: 30px;background: #fffa90"></a></td>--%>
<%--                    </tr>--%>
<%--                </c:forEach>--%>
<%--                </tbody>--%>
<%--            </table>--%>
