                                    ...
                                    <div class="w3l-table-info">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                                <mvc:form modelAttribute="customerID" action="${pageContext.request.contextPath}/staff/saveCustomer" method="post">
                                                    <div class="form-group">
                                                        <label for="ten">ID</label>
                                                        <mvc:input path="id" required="false" class="form-control" placeholder="Nhập ID" readonly="true"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="ten">Tên khách hàng</label>
                                                        <mvc:input path="customerName" required="false" class="form-control" placeholder="Nhập tên khách hàng"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="ten">Địa chỉ</label>
                                                        <mvc:input path="address" required="false" class="form-control" placeholder="Nhập địac chỉ"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="ten">Số điện thoại</label>
                                                        <mvc:input path="phoneNumber" required="false" class="form-control" placeholder="Nhập số điện thoại"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="ten">Email</label>
                                                        <mvc:input path="email" required="false" class="form-control" placeholder="Nhập email"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="ten">ID khách hàng</label>
                                                        <mvc:input path="idNumber" required="false" class="form-control" placeholder="Nhập id khách hàng"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <mvc:input type="hidden" path="account.id"/>
                                                    </div>
