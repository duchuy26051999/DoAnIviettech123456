                                    ...
                                    <div class="w3l-table-info">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                                <mvc:form modelAttribute="category" action="${pageContext.request.contextPath}/staff/saveCategory" method="post">
                                                    <div class="form-group">
                                                        <label for="ten">ID:</label>
                                                        <mvc:input path="id"  class="form-control" required="false" readonly="true"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="ten">Tên thể loại</label>
                                                        <mvc:input path="category"  class="form-control" required="false" placeholder="Nhập tên thể loại"/>
                                                    </div>
