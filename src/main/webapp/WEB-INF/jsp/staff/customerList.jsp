                ...
                <div class="agile-calendar-grid">
                    <div class="page">
                        ...
                        <div class="w3l-calendar-left">
                            <div class="calendar-heading">
                                ...
                                <div class="agile-tables">
                                    <div class="w3l-table-info">
                                        ...
                                        <form action="${pageContext.request.contextPath}/staff/searchCustomerName" method="post">
                                            <input type="text" name="search" required placeholder="Nhập (tên khách hàng,địa chỉ, ID khách hàng)">
                                            <input type="submit" value="Tìm kiếm">
                                            <a href="${pageContext.request.contextPath}/staff/manageCustomer"><input type="button" value="Xem tất cả"></a>
                                        </form>
                                        <table id="table">
                                            <thead >
                                            <tr >
							...
							<span >
								<a class="agile-icon" href="${pageContext.request.contextPath}/staff/updateCustomer/${customer.id}"><i class="fa fa-pencil-square-o"></i></a>
							</span>
<%--                                                        <span>--%>
